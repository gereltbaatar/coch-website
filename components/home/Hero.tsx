      ...
      <div className="max-w-[1536px] w-full mx-auto px-5 py-12 sm:py-16 lg:py-20">
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-10">
          ...
          <div className="w-full lg:w-1/2 flex justify-center lg:justify-center">
            <div className="relative h-[730px] w-full rounded-3xl overflow-hidden">
              <Image
                src="/HeroImage.jpg"
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center space-y-8 sm:space-y-10">
            ...
            <div className="space-y-3">
              <h1 className="text-4xl sm:text-6xl lg:text-6xl xl:text-8xl font-light tracking-tight text-[#2a2a2a] leading-[1.1]">
                Helping you uncover
              </h1>
              <h1 className="text-4xl sm:text-6xl lg:text-6xl xl:text-8xl font-light tracking-tight leading-[1.1]">
            ...
            <div className="pt-2">
              <Link
                href="/contact"
                className="group inline-flex items-center gap-3 bg-main hover:bg-main/90 text-white font-light text-sm sm:text-base tracking-wide px-10 sm:px-12 py-4 sm:py-5 rounded-full transition-all duration-300 cursor-pointer shadow-md hover:shadow-xl transform"
              >
                Book Now
