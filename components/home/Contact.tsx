        ...
        <section className="bg-secondary w-full py-12 sm:py-16 lg:py-24" id="contact">
            <div className="w-full max-w-[1536px] mx-auto px-4 sm:px-6">
                <motion.div
                    ...
                    className="flex flex-col lg:flex-row bg-white rounded-3xl overflow-hidden"
                >
                    {/* Left Side - Image */}
                    <motion.div
                        ...
                        className="w-full lg:w-1/2 relative min-h-[300px] lg:min-h-full"
                    >
                        <Image
                            src="/onetoone.png"
                            alt="Contact Us"
                    ...
                    <motion.div
                        ...
                        className="w-full lg:w-1/2 p-8 sm:p-12 lg:p-16 bg-secondary"
                    >
                ...
                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                        ...
                        <motion.a
                            ...
                            className="flex items-center gap-4 bg-white rounded-2xl p-6 hover:shadow-lg transition-all duration-300"
                        >
